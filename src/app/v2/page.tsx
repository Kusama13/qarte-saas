      ...
      <nav className="fixed top-[36px] left-0 right-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
            ...
            <a href="/auth/merchant" className="px-5 py-2.5 bg-gradient-to-r from-pink-500 to-fuchsia-600 hover:from-pink-600 hover:to-fuchsia-700 text-white rounded-lg transition-all shadow-sm hover:scale-[1.02] active:scale-[0.98] hover:shadow-lg">Espace Pro</a>
          </div>
        ...
        <div className={`space-y-8 ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div className="relative">
            ...
            <h1 className="relative text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-fuchsia-500 to-rose-500">
                sans effort.
              </span>
            </h1>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-xl leading-relaxed">
            La carte de fidélité digitale pour les <span className="text-gray-900 font-medium">instituts de beauté, spas et salons.</span> Simple, élégante et efficace.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <a
              ...
              className="group relative px-8 py-4 bg-gradient-to-r from-pink-500 to-fuchsia-600 text-white font-bold rounded-xl transition-all duration-300 text-center shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-gray-200/60">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600"><span className="font-semibold text-gray-900">150+</span> professionnelles</span>
            </div>
...
function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Analysez le comportement de vos clientes en temps réel. Fréquence de visite, panier moyen et segments les plus rentables.",
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-bold text-slate-900">Institut Beauté Plus</p>
                      <p className="text-[11px] text-slate-600 mt-0.5">🎉 -20% sur les soins ce weekend !</p>
                    </div>
                  </div>
                </motion.div>
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6">
        <div className={`text-center mb-12 ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
            Comment L&apos;Institut Beauté Plus a{' '}
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-10">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-400 to-fuchsia-500 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  IB
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Institut Beauté Plus</h3>
                  <p className="text-gray-500 text-sm">Lyon 6ème • Institut de beauté</p>
                </div>
              </div>

              <blockquote className="text-lg text-gray-700 leading-relaxed mb-6 italic border-l-4 border-pink-200 pl-4">
                "Avant Qarte, je tamponnais des cartes papier que mes clientes perdaient systématiquement. Aujourd&apos;hui, 80% de mes clientes ont leur carte digitale et reviennent 2x plus souvent."
              </blockquote>
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Laura Martin</p>
                  <p className="text-sm text-gray-500">Gérante depuis 2019</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  'Notification push pour les offres'
                ].map((item, i) => (
            ...
            {/* Right: Results */}
            <div className="bg-gradient-to-br from-pink-500 to-fuchsia-600 p-8 md:p-10 text-white">
              <h4 className="text-sm font-bold uppercase tracking-wider text-pink-200 mb-8">
...
function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'La mise en place a pris 5 minutes. Mes clientes adorent scanner le QR code après leur soin.',
    ...
    },
    {
      name: 'Nadia K.',
      role: 'Spa & Bien-être',
      content: 'J\'ai enfin des données sur mes clientes. Je peux leur envoyer des offres personnalisées.',
      image: '/images/temoignages/nadia.webp',
      stat: '+25%',
    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 relative">
        <div className={`text-center mb-12 transition-all duration-1000 transform ${isInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">Découvrez ce que nos clientes disent de Qarte</p>
        </div>
...
function TrustBanner() {
  ...
  const floatingIcons = [
    ...
    { Icon: Star, bottom: '25%', left: '12%', delay: 1.2 },
    { Icon: Gift, bottom: '20%', right: '15%', delay: 0.4 },
  ];
        ...
        >
          ...
          <div className="space-y-3">
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 tracking-tight">
              professionnelles nous font confiance
            </h3>
...
function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Placez-le à l\'accueil. Vos clientes scannent avec leur téléphone.',
      icon: QrCode,
