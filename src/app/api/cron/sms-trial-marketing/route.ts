...
const SELECT = 'id, shop_name, phone, country, created_at, bio, shop_address, trial_ends_at, subscription_status, churn_survey_seen_at, no_contact, email_unsubscribed_at, marketing_sms_opted_out, example_vitrine_sms_sent_at, celebration_sms_sent_at, pre_loss_sms_sent_at, churn_sms_sent_at';
