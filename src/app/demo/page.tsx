    ...
    <div className="min-h-screen flex flex-col transition-colors duration-500" style={{ background: `linear-gradient(135deg, white, ${primaryColor}12)` }}>
      ...
      <main className="flex-1 px-4 pt-4 pb-4 mx-auto max-w-md w-full">
        ...
        <div className="flex items-center justify-center mb-3">
          <div
            className="group relative flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50/80 border border-emerald-100"
          >
            <div className="relative flex items-center justify-center">
              <Bell className="w-3 h-3 text-emerald-600" />
              <div className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-emerald-500 rounded-full border border-emerald-50" />
            </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="mt-4 bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
              <div className="flex flex-col items-center text-center space-y-3">
                {/* Google Logo */}
                <div className="flex items-center justify-center bg-white p-1.5 rounded-full shadow-sm border border-gray-50">
                ...
                <div className="space-y-1">
                  <h3 className="text-sm font-semibold text-gray-800">Votre avis compte !</h3>
                  <p className="text-[11px] text-gray-500">
                    Aidez-nous à grandir en partageant votre expérience.
                  </p>
                </div>
                ...
                <button
                  ...
                  className="w-full h-9 bg-white border border-gray-200 hover:border-blue-400 rounded-lg text-[13px] font-medium text-gray-700 transition-all flex items-center justify-center gap-2 shadow-sm hover:shadow"
                >
                ...
                {reviewRating > 0 && (
                  <p className="text-[10px] text-blue-500 font-medium">
                    Merci pour vos {reviewRating} étoiles !
                  </p>
                )}
              </div>
            </div>
