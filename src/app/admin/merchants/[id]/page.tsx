...
// --- Extract pseudo from social URL ---
...
function extractPseudo(url: string | null): string | null {
  ...
  try {
    ...
    // Facebook: /profile.php?id=xxx or /pagename
    // TikTok: /@username
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-100 p-4 sm:p-6">
        ...
        {(() => {
          const checklistItems = [
            ...
            { label: 'Réseau social ajouté', done: !!(merchant.instagram_url || merchant.facebook_url || merchant.tiktok_url || merchant.snapchat_url) },
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              ...
              {merchant.instagram_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-pink-200 bg-pink-50 hover:bg-pink-100 text-sm text-gray-700 hover:text-pink-600 transition-colors"
                >
                  <svg className="w-4 h-4 flex-shrink-0 text-pink-500" viewBox="0 0 24 24" fill="currentColor">
              ...
              {merchant.facebook_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-blue-200 bg-blue-50 hover:bg-blue-100 text-sm text-gray-700 hover:text-blue-600 transition-colors"
                >
              ...
              {merchant.tiktok_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-sm text-gray-700 hover:text-gray-900 transition-colors"
                >
