...
import { CalendarDays, CalendarPlus, Clock, ChevronRight, Pencil, X, ImageIcon, Download, Instagram, Check, MessageSquare } from 'lucide-react';
...
export default function ReservationsSection({ slots, services, serviceColorMap, locale, merchantCountry, merchantName, merchantAddress, depositPercent, depositAmount: depositFixed, onEditSlot, onConfirmDeposit, onCancelDeposit, subscriptionStatus, deepLinkSlotId, onDeepLinkHandled }: ReservationsSectionProps) {
