...
import { getSlotServiceIds } from './utils';
...
export default function UpcomingSection({ slots, services, locale, onSlotClick }: UpcomingSectionProps) {
  const t = useTranslations('planning');

  // Group booked slots by day
  const dayGroups = useMemo(() => {
    const bookedSlots = slots.filter(s => s.client_name && s.client_name !== '__blocked__');
