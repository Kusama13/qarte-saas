          ...
          <div className="mt-6 lg:mt-0 space-y-4">
            ...
            <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm space-y-3">
              ...
              <Button
                ...
                className="w-full h-12 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl active:scale-[0.98] touch-manipulation transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {downloadSuccess ? (
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm space-y-3">
              ...
              <Button
                ...
                className="w-full h-12 bg-pink-500 hover:bg-pink-600 text-white font-bold rounded-xl active:scale-[0.98] touch-manipulation transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isGenerating ? (
      ...
      {activeTab === 'nfc' && (
        <div className="animate-in fade-in duration-300 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          ...
          <div className="mt-6 lg:mt-0 space-y-4">
            ...
            <Link
              href="/boutique"
              className="flex items-center justify-center gap-2 w-full h-12 bg-[#4b0082] hover:bg-[#3a0066] text-white font-bold rounded-xl active:scale-[0.98] touch-manipulation transition-all text-sm"
            >
              <Nfc className="w-5 h-5" strokeWidth={2.25} />
              {t('nfcOrder')}
            </Link>
          </div>
          </div>
          ...
          <div className="relative w-full max-w-xs bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 text-center">
            ...
            <div className="px-6 pt-8 pb-6">
              <div className="w-12 h-12 mx-auto rounded-xl bg-indigo-50 flex items-center justify-center mb-4">
                <Users className="w-5 h-5 text-indigo-600" strokeWidth={2.25} />
              </div>
              ...
              <Link
                ...
                onClick={() => setShowPostDownloadModal(false)}
                className="mt-5 w-full py-3 bg-[#4b0082] hover:bg-[#4b0082]/90 text-white font-bold text-sm rounded-xl active:scale-[0.98] touch-manipulation transition-all inline-block"
              >
                {t('postDownloadCta')}
              </Link>
              <button
