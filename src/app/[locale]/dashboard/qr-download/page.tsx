        ...
        <div className="animate-in fade-in duration-300 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          ...
          <div className="mt-6 lg:mt-0 space-y-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full h-12 bg-[#25D366] hover:bg-[#1ebe5b] text-white font-bold rounded-xl active:scale-[0.98] touch-manipulation transition-all text-sm"
            >
