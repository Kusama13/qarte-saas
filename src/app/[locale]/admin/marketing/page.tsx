...
Je vous propose 3 jours d'essai gratuit, sans engagement.
...
Essai gratuit 3 jours. Je peux vous faire une démo ?
...
Intéressé(e) par 3 jours d'essai gratuit ?
...
3 jours d'essai gratuit, ça vous dit ?
...
Essai gratuit 3 jours. Intéressé(e) ?
...
CTA BUTTON: "3 jours gratuits" or "Essai gratuit"
...
CTA: "Testez gratuitement 3 jours"
FOOTER: "getqarte.com"
      ...
      <div className="bg-gradient-to-br from-[#5167fc] to-[#7c3aed] rounded-lg p-6 text-white">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="bg-white/10 rounded-lg p-4">
            ...
            <ul className="text-sm text-white/80 space-y-1">
              <li>• 3 jours gratuits, sans engagement</li>
          ...
          <div className="bg-white/10 rounded-lg p-4">
            ...
            <ul className="text-sm text-white/80 space-y-1">
              ...
              <li>• &quot;Ça coûte cher&quot; → 3 jours gratuits pour tester</li>
            </ul>
          </div>
          <div className="bg-white/10 rounded-lg p-4">
            <h3 className="font-medium mb-2 flex items-center gap-2">
