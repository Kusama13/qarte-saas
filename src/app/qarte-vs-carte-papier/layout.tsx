...
export const metadata: Metadata = {
  ...
  description:
    '73% des cartes papier sont perdues. Decouvrez pourquoi les salons de beaute passent a la carte de fidelite digitale Qarte : notifications push, anti-fraude, statistiques, zero impression. Essai gratuit 15 jours.',
  keywords: [
