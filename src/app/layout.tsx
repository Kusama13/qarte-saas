...
const DESCRIPTION = "Qarte — l'app tout-en-un des salons de beauté : carte de fidélité digitale, réservation en ligne sans commission, page salon. Essai 3 jours.";
...
export const metadata: Metadata = {
  ...
  verification: {
    ...
    other: {
      'facebook-domain-verification': 'oq5wwz7b9cnc826lodmv6unxgae5p8',
    },
  },
};
