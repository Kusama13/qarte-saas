export const fr = {
  ...
  welcome: {
    ...
    intro: 'Ton compte Qarte est créé. Voici les deux piliers pour <strong>remplir ton agenda</strong> et <strong>fidéliser tes clientes</strong>.',
    step1Title: 'Étape 1 — Programme fidélité',
    step1Feature1: 'Tampons ou cagnotte cashback',
    step1Feature2: 'QR code personnalisé à tes couleurs',
    step1Feature3: 'Parrainage et avis Google automatiques',
    step1Feature4: 'Cadeau anniversaire envoyé tout seul',
    ctaPersonalize: 'Configurer mon programme',
    step2Title: 'Étape 2 — Vitrine en ligne',
    step2Feature1: 'Bio, horaires, adresse, photos de réalisations',
    step2Feature2: 'Réservation en ligne + gestion des acomptes',
    step2Feature3: 'SMS de rappel et de confirmation automatiques',
    step2Feature4: 'Offre de bienvenue + référencement Google (SEO)',
    ctaPublicPage: 'Compléter ma vitrine',
    ...
    trialNote: '{trialDays} jours d\'essai gratuit, sans carte bancaire. 100 SMS/mois inclus avec ton abonnement.',
  ...
  trialEnding: {
    ...
    lossWarning: 'Sans abonnement, tu perds l\'accès à ton programme fidélité, ta vitrine en ligne, tes réservations, les SMS de rappel, les relances automatiques, le parrainage, les cadeaux anniversaire et tes données clients.',
  ...
  gracePeriodSetup: {
    ...
    reassurance: 'Après configuration, tu pourras réactiver ton abonnement à <strong>24€/mois</strong>, sans engagement.',
