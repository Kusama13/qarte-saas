export const fr = {
  ...
  welcome: {
    preview: '{shopName}, ta vitrine en ligne et ton programme de fidélité sont prêts',
    heading: 'Bienvenue {shopName} !',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Ton compte Qarte est créé. Tu as maintenant une <strong>vitrine en ligne complète</strong> et un <strong>programme de fidélité</strong> prêts à l\'emploi.',
    readyTitle: 'Ce qui est déjà prêt pour toi',
    stepPagePro: '<strong>Ta vitrine en ligne</strong> — bio, prestations, photos, horaires. Une seule page à partager, visible sur Google.',
    ...
    ctaPersonalize: 'Personnalise ta vitrine en 5 min',
    publicPageTitle: 'Ta vitrine en ligne est déjà en ligne',
    publicPageText: 'Tes clientes y retrouvent ton salon, tes prestations, ton programme de fidélité et la prise de rendez-vous. Ajoute-la dans ta bio Instagram.',
