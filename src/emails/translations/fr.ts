export const fr = {
  ...
  welcome: {
    ...
    intro: 'Ton compte Qarte est créé. <strong>Ta vitrine en ligne</strong>, <strong>ton programme de fidélité</strong> et <strong>ta réservation en ligne</strong> t\'attendent.',
    readyTitle: 'Prochaine étape',
    stepPagePro: 'Choisis tes couleurs, ajoute ton logo et configure ta récompense fidélité. Active la réservation en ligne pour que tes clientes prennent rendez-vous directement depuis ta vitrine. Ça prend 5 minutes.',
    stepPlanning: '',
    stepLoyalty: '',
  ...
  trialEnding: {
    ...
    lossWarning: 'Sans abonnement, tu perds l\'accès à ton programme fidélité, ta vitrine en ligne, tes réservations, tes relances automatiques, le parrainage, les cadeaux anniversaire et tes données clients.',
  ...
  inactiveDay14: {
    ...
    competitorText: 'Les pros sur Qarte fidélisent avec un scan, acceptent les réservations en ligne, envoient des cadeaux anniversaire automatiques et activent le parrainage. Résultat : leurs clientes reviennent plus souvent.',
  ...
  reactivation: {
    ...
    dataStillHere: 'Tes données sont encore là. Réactive ton compte pour reprendre où tu en étais — avec toutes les nouvelles fonctionnalités : vitrine en ligne, réservation automatique, parrainage et cadeaux anniversaire.',
