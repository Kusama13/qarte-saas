export const fr = {
  ...
  welcome: {
    preview: '{shopName}, ta page pro et ton programme de fidélité sont prêts',
    heading: 'Bienvenue {shopName} !',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Ton compte Qarte est créé. Tu as maintenant une <strong>page pro complète</strong> et un <strong>programme de fidélité</strong> prêts à l\'emploi.',
    readyTitle: 'Ce qui est déjà prêt pour toi',
    stepPagePro: '<strong>Ta page pro</strong> — bio, prestations, photos, horaires. Une seule page à partager, visible sur Google.',
    stepPlanning: '<strong>Ton planning en ligne</strong> — tes clientes voient tes dispos et réservent directement.',
    stepLoyalty: '<strong>Ton programme de fidélité</strong> — tampons ou cagnotte, relances automatiques, avis Google.',
    ctaPersonalize: 'Personnalise ta page en 5 min',
    publicPageTitle: 'Ta page publique est déjà en ligne',
    publicPageText: 'Tes clientes y retrouvent ton salon, tes prestations, ton programme de fidélité et la prise de rendez-vous. Ajoute-la dans ta bio Instagram — c\'est mieux qu\'un Linktree.',
    ctaPublicPage: 'Voir ma page publique',
    tipTitle: 'Astuce :',
    tipText: 'Configure une offre de bienvenue (ex : -20% première visite) depuis ton tableau de bord. Elle s\'affichera automatiquement sur ta page publique pour attirer de nouvelles clientes — sans dépenser en publicité.',
  ...
  announcementMaPage: {
    ...
    badgeNew: 'Nouveau',
    feature1Title: 'Ta page pro est en ligne',
    ...
    summaryText: 'Programme de fidélité, parrainage, offre de bienvenue, page pro… Qarte te donne tout ce qu\'il faut pour garder tes clients et en attirer de nouveaux. Tout ça dans un seul abonnement.',
