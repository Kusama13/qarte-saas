export const fr = {
  ...
  inactiveDay30: {
    preview: 'On a pas réussi à te montrer la valeur ce mois-ci — 3 options pour toi',
    heading: 'On rouvre la conversation, {shopName}',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Honnêtement : on a pas réussi à te montrer la valeur de Qarte ce mois-ci. On aimerait savoir pourquoi, et te proposer 3 options concrètes.',
    optionsTitle: '3 options, tu choisis',
    option1Title: '1. Pause 2 mois',
    option1Desc: 'On met ton compte en pause (0€/mois). Tes données restent là, tu reprends quand tu veux.',
    option2TitleFidelity: '2. 30 min avec moi pour débloquer',
    option2DescFidelity: 'Gratuit. On débloque ensemble ce qui te gêne — config, cas concret sur ton commerce, questions.',
    option2TitleAllIn: '2. Downgrade en Fidélité (24 → 19€)',
    option2DescAllIn: 'Si tu n\'utilises pas le planning ni les SMS marketing, le plan Fidélité te suffit.',
    option3Title: '3. 30 min avec moi pour débloquer',
    option3Desc: 'Gratuit. On débloque ensemble ce qui te gêne — config, cas concret sur ton commerce, questions.',
    cta: 'Choisir mon option',
