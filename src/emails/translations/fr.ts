export const fr = {
  ...
  welcome: {
    preview: '{shopName}, ton salon vient de passer au niveau supérieur',
    heading: 'Ton salon vient de passer au niveau supérieur.',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'A partir de maintenant, tes clientes peuvent te trouver en ligne, réserver en un clic et revenir toutes seules grâce à la fidélité.',
    benefitsTitle: 'Ce qui change pour toi :',
    benefit1: 'Tes clientes réservent sans t\'appeler — tu reçois une notif instantanée',
    benefit2: 'Tampons ou cagnotte — elles reviennent et dépensent plus',
    benefit3: 'Parrainage, anniversaires, avis Google — tout tourne en automatique',
    smsTitle: 'En ajoutant ta carte bancaire, tu débloques :',
    sms1: 'SMS de rappel la veille du RDV — zéro no-show',
    sms2: 'SMS de confirmation instantané à la réservation',
    sms3: '100 SMS/mois inclus dans ton abonnement',
