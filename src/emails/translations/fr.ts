export const fr = {
  subjects: {
    ...
    postSurveyFollowUpLowerPrice: '{shopName}, ton code 15€ de remise t\'attend',
  ...
  churnSurveyReminder: {
    ...
    offerText: 'Réponds à 4 questions (moins de 2 min) et on te rallume ton compte avec tes données intactes. Si le prix était le blocage, on ajoute un code promo de 15€.',
  ...
  postSurveyFollowUp: {
    ...
    signature: 'L\'équipe Qarte 💜',
    lowerPrice: {
      preview: '{shopName}, on rouvre ton compte — ton code 15€ est dedans',
      ...
      promoLabel: 'Ton code 15€ de remise',
  ...
  postSurveyLastChance: {
    ...
    lowerPrice: {
      ...
      intro: 'Ton essai bonus se termine aujourd\'hui. Après minuit, le code <strong>MRSSURVEY15</strong> ne fonctionnera plus et tes données seront supprimées.',
