export const fr = {
  ...
  trialEnding: {
    ...
    tierFidelityDesc: 'Programme tampons/cagnotte + 50 SMS/mois (anniversaires, parrainage) + vitrine SEO. Sans planning ni résa en ligne.',
  ...
  plansLaunch: {
    ...
    tierFidelityPrice: '19€/mois ou 190€/an',
    tierFidelityDesc: 'Pour les pros qui ont déjà un outil de booking (Planity, Booksy…) et veulent juste fidéliser : programme tampons/cagnotte + 50 SMS/mois (anniversaires, parrainage) + vitrine SEO. Pas de planning ni de résa en ligne.',
