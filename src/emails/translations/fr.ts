export const fr = {
  subjects: {
    ...
    paymentFailedStep2: '{shopName}, ton accès est suspendu',
    paymentFailedStep3: '{shopName}, ton compte est suspendu depuis 4 jours',
    paymentFailedStep4: '{shopName}, dernière relance — suspendu depuis 7 jours',
    subscriptionCanceled: '{shopName} - Confirmation de résiliation',
    subscriptionForceCanceled: '{shopName} — ton abonnement a été annulé',
    ...
    reactivationRecent: 'Ta page beauté est restée à mi-chemin',
    reactivationTiede: 'Pourquoi 70% des nouvelles clientes ne reviennent pas',
    reactivationAncien: 'Qarte n\'est plus le même qu\'à ton inscription',
  ...
  welcome: {
    ...
    replyPrompt: 'R\u00e9ponds <strong>OK</strong> \u00e0 cet email pour activer tes 3 jours d\u2019essai gratuit.',
  ...
  trialEnding: {
    ...
    tierAllInPrice: '34€/mois ou 170€/6 mois',
    ...
    tierFidelityPrice: '14€/mois ou 70€/6 mois',
    tierFidelityDesc: 'Programme tampons/cagnotte + SMS anniversaire offert (parrainage via pack SMS) + vitrine SEO. Sans planning ni résa en ligne.',
    ...
    socialProof: '800+ pros de la beauté fidélisent déjà avec Qarte.',
  ...
  trialExpired: {
    ...
    specialOfferPrice: '34€/mois — sans engagement',
    promoLabel: 'CODE PROMO',
    ...
    ctaPromo: 'Réactiver mon compte — 34€/mois',
    ctaNoPromo: 'Réactiver mon compte — 34€/mois',
  ...
  subscriptionConfirmed: {
    ...
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    introAllIn: 'Merci pour ta confiance ! Ton abonnement Tout-en-un est actif, tes <strong>{smsQuota} SMS/mois sont débloqués</strong> — rappels, confirmations et anniversaires partent automatiquement. Planning et réservation en ligne activés.',
    introFidelity: 'Merci pour ta confiance ! Ton abonnement Fidélité est actif. Programme de fidélité, vitrine, parrainage et avis Google tournent pour toi. Le SMS anniversaire part automatiquement, sans compteur ; le parrainage utilise tes packs SMS.',
  ...
  subscriptionForceCanceled: {
    preview: '{shopName} — ton abonnement Qarte a été annulé après plusieurs paiements échoués',
    heading: 'Ton abonnement a été annulé',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Après plusieurs tentatives de paiement infructueuses, ton abonnement Qarte vient d\'être annulé. Ton accès au dashboard, à ta vitrine et au programme de fidélité est suspendu.',
    whatHappenedTitle: 'Ce qui s\'est passé',
    whatHappenedText: 'On a essayé de prélever ton abonnement plusieurs fois ces derniers jours, sans succès (carte expirée, plafond, blocage banque…). Faute de paiement, l\'abonnement a été annulé automatiquement.',
    dataTitle: 'Tes données',
    dataRetention: 'On garde tes données (clientes, RDV, programme de fidélité) pendant 30 jours. Au-delà, elles seront définitivement supprimées.',
    dataContact: 'Si tu veux récupérer un export ou demander la suppression anticipée, écris-nous à support@getqarte.com.',
    comeBackTitle: 'Tout est encore là',
    comeBackText: 'Tu peux réactiver ton compte en quelques secondes : ajoute une carte valide et tout repart comme avant. Tes clientes, ton programme, tes RDV — rien n\'est perdu tant qu\'on est dans la fenêtre des 30 jours.',
    ctaReactivate: 'Réactiver mon compte',
    helpText: 'Un souci avec ta banque ou ta carte ? Réponds à cet email, on t\'aide à régulariser.',
    signaturePrefix: 'On reste là si besoin,',
    signature: 'L\'équipe Qarte 💜',
  },
  ...
  paymentFailed: {
    ...
    step2: {
      preview: '{shopName} — ton accès est suspendu',
      heading: 'Ton accès Qarte est suspendu',
      greeting: 'Bonjour <strong>{shopName}</strong>,',
      intro: 'Ton paiement a échoué plusieurs fois. <strong>Ton accès Qarte est désormais suspendu</strong> : tes clientes ne peuvent plus réserver, scanner leur carte ni utiliser leurs récompenses.',
      cta: 'Mettre à jour ma carte — 30 secondes',
      helpText: 'Dès la mise à jour de ta carte, tout est réactivé immédiatement. Un problème avec ta banque ? Réponds à cet email.',
    },
    step3: {
      preview: '{shopName} — ton compte est suspendu depuis 4 jours',
      heading: 'Ton compte est suspendu depuis 4 jours',
      greeting: '<strong>{shopName}</strong>,',
      intro: 'Ton compte Qarte est suspendu depuis 4 jours pour défaut de paiement. Tes clientes ne peuvent plus rien faire en attendant.',
      urgentText: 'Réservations en ligne, scans de fidélité, récompenses, vitrine — tout est désactivé jusqu\'à la mise à jour de ta carte.',
      cta: 'Régulariser maintenant',
      helpText: 'Besoin d\'aide ? Réponds directement à cet email.',
    },
    step4: {
      preview: '{shopName} — suspendu depuis 7 jours, dernière relance',
      heading: 'Dernière relance — suspendu depuis 7 jours',
      greeting: '<strong>{shopName}</strong>,',
      intro: 'Ton compte Qarte est suspendu depuis 7 jours. Sans paiement, l\'annulation deviendra définitive et tu perdras l\'accès à ton programme de fidélité, ton planning et ta vitrine.',
      urgentText: 'Toutes tes données clientes, RDV à venir, vouchers actifs — tout sera perdu si l\'annulation devient définitive.',
      cta: 'Régulariser — 30 secondes',
  ...
  gracePeriodSetup: {
    ...
    reassurance: '34€/mois, sans engagement. Réservations en ligne, SMS de rappel, fidélité, parrainage — tout est inclus.',
    socialProof: '800+ pros ont déjà configuré leur programme en quelques minutes.',
    socialProofLink: 'Voir leurs programmes →',
  ...
  inactiveDay30: {
    ...
    option1TitleAllIn: '1. Un coup de main pour reprendre',
    option1DescAllIn: 'Dis-nous ce qui te bloque en répondant à cet email : on t\'aide à réactiver tes réservations, ta fidélité et tes relances.',
  ...
  challengeCompleted: {
    ...
    ctaDashboard: 'Accéder à mon tableau de bord',
    signature: 'L\'équipe Qarte 💜',
    monthlyPromoValue: '<strong>34€/mois</strong> sans engagement',
  ...
  lastChanceSignup: {
    ...
    body2: 'L\'inscription prend <strong>3 minutes</strong> et l\'essai est 100% gratuit pendant 3 jours, sans carte bancaire.',
  ...
  reactivationRecent: {
    preview: '2 minutes pour la finir, je te montre.',
    heading: 'Ta page est restée à mi-chemin',
    greeting: 'Salut <strong>{shopName}</strong>,',
    intro: 'Tu as commencé à créer ta page Qarte il y a quelques semaines, puis la vie de salon a repris le dessus. C\'est normal, entre deux clientes on n\'a pas le temps.',
    body: 'Le truc, c\'est que ta page est presque prête. Il te manque souvent juste une chose : tes prestations, ou ta première photo.',
    exampleText: 'Pour te donner une idée du résultat, regarde la page d\'une coiffeuse comme toi.',
    exampleCta: 'Voir un exemple',
    momentumTitle: 'Petit truc en passant',
    momentum: 'On voit arriver de plus en plus de pros qui quittaient Planity ou Booksy, fatiguées de payer cher tous les mois. Le mouvement s\'accélère, et ça nous ferait plaisir que tu en fasses partie.',
    cta: 'Finir ma page',
    helpText: 'Et si quelque chose t\'a bloquée, réponds-moi directement à ce mail, je lis tout.',
    signature: 'L\'équipe Qarte 💜',
  },

  reactivationTiede: {
    preview: 'Et les 3 choses qui changent ça, sans rien dépenser.',
    heading: '7 nouvelles clientes sur 10 ne reviennent jamais',
    greeting: 'Salut <strong>{shopName}</strong>,',
    intro: 'Petit chiffre qui pique : sur 10 nouvelles clientes, 7 ne reviennent jamais. Pas parce qu\'elles n\'ont pas aimé, juste parce que rien ne les fait revenir.',
    body: '3 choses simples y changent quelque chose, et tu peux les mettre en place même sans outil :',
    tip1: 'Demande le prénom et le mois d\'anniversaire à l\'encaissement. Un petit message le bon mois, et elles reviennent.',
    tip2: 'Donne une raison de revenir : « à la 6e visite, le brushing est offert ». Simple, ça marche.',
  ...
  reactivationAncien: {
    preview: 'Ce qu\'on a ajouté depuis, en 30 secondes.',
    heading: 'Deux choses ont changé depuis ton inscription',
    greeting: 'Salut <strong>{shopName}</strong>,',
    intro: 'Tu as testé Qarte il y a un moment. Honnêtement, à l\'époque, il manquait des choses. Depuis, deux choses ont changé.',
    point1Title: 'Un : on a beaucoup avancé',
    point1Text: 'Réservation en ligne sans commission (l\'acompte tombe direct sur ton compte), service à domicile avec calcul auto des trajets, bons cadeaux vendus depuis ta page, et rappels SMS la veille pour diviser les rendez-vous manqués.',
    point2Title: 'Deux : on n\'est plus le petit nouveau',
    point2Text: 'De plus en plus de pros quittent Planity et Booksy pour nous rejoindre, lassées de payer cher chaque mois. Le mouvement s\'accélère, et on aimerait que tu sois de l\'aventure.',
    body: 'Pas besoin de te réinscrire : ton compte t\'attend. Jette juste un œil à quoi ressemble une page aujourd\'hui.',
    cta: 'Voir les exemples',
    reassurance: 'Et si Qarte n\'est pas pour toi, pas de souci, tu peux te désinscrire en bas. Je comprends.',
    signature: 'L\'équipe Qarte 💜',
  },
  ...
  trialFinalDay: {
    ...
    body: 'Si Qarte te convient, l\'abonnement démarre à 34€/mois sans engagement, résiliable en 1 clic.',
