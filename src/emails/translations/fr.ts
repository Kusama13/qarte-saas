export const fr = {
  subjects: {
    ...
    incompleteSignup2: 'Votre espace Qarte vous attend toujours',
    ...
    plansLaunch: '{shopName}, on a élargi la gamme — ton tarif est préservé',
  ...
  plansLaunch: {
    preview: '{shopName}, on a élargi la gamme — ton tarif est préservé',
    heading: 'On a élargi la gamme Qarte',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Tu utilises Qarte aujourd\'hui — on voulait te tenir au courant en premier : on lance un nouveau plan plus léger pour les pros qui veulent juste de la fidélité, et on garde ton tarif actuel intact.',
    badgeReassure: 'Pour toi',
    reassureTitle: 'Ton tarif ne bouge pas',
    reassureText: 'Tu restes sur ton tarif actuel à <strong>{currentPrice}</strong> avec <strong>toutes les fonctionnalités Tout-en-un</strong> (planning, résa en ligne, programmes Membres, jeu concours, campagnes SMS). Aucune action de ta part.',
    whatChangesTitle: 'Ce qui change',
    tierAllInName: 'Tout-en-un (ton plan actuel)',
    tierAllInPrice: '24€/mois ou 240€/an',
    tierAllInDesc: 'Programme de fidélité + planning + réservation en ligne + 100 SMS marketing/mois + campagnes SMS modérées + programmes Membres VIP + jeu concours mensuel + vitrine SEO complète.',
    tierFidelityName: 'Nouveau : Fidélité seule',
    tierFidelityPrice: '19€/mois ou 190€/an',
    tierFidelityDesc: 'Pour les pros qui ont déjà un outil de booking (Planity, Booksy…) et veulent juste fidéliser : programme tampons/cagnotte + SMS anniversaire et parrainage envoyés automatiquement (inclus, sans quota) + vitrine SEO. Pas de planning ni de résa en ligne.',
    actionText: 'Tu peux passer en plan Fidélité depuis ta page Abonnement si tu veux alléger ton coût mensuel — ou rester sur ton tarif Tout-en-un actuel à vie.',
  ...
  postSurveyLastChance: {
    ...
    lowerPrice: {
      ...
      intro: 'Ton essai bonus se termine aujourd\'hui. Ton code promo <strong>3MOISQARTEPRO25</strong> ne sera plus valable demain.',
      promoLabel: 'Dernière chance',
      promoCode: '3MOISQARTEPRO25',
      cta: 'Activer mon code promo',
    },
    longerTrial: {
