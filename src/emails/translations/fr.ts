export const fr = {
  subjects: {
    ...
    inactiveDay14: '{shopName}, tes clientes oublient de revenir ?',
    ...
    planningReminder: '{shopName}, tes clientes veulent reserver en ligne',
  ...
  trialEnding: {
    preview: 'Tes clientes vont perdre leur carte de fidelite',
    ...
    urgentMessage: 'Le programme que tu as configure, ta vitrine, tes donnees clients — tout sera desactive. Tes clientes ne pourront plus scanner leur carte ni reserver.',
    normalMessage: 'Sans abonnement, le programme que tu as pris le temps de configurer sera desactive. Tes clientes perdent leur carte, leurs points et leurs recompenses.',
    lossWarning: 'Ce que tes clientes perdent : leur carte de fidelite, leurs points cumules, la reservation en ligne, les rappels SMS et leurs recompenses en cours.',
  ...
  paymentFailed: {
    ...
    step2: {
      ...
      greeting: 'Bonjour <strong>{shopName}</strong>,',
      intro: 'On a réessayé ton paiement mais ça n\'a pas fonctionné. Pour garder ton accès à Qarte, mets à jour ta carte maintenant.',
      cta: 'Mettre à jour ma carte',
  ...
  gracePeriodSetup: {
    ...
    heading: 'Tes données seront supprimées dans {daysUntilDeletion} jours',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
  ...
  subscriptionReactivated: {
    ...
    feature3: '✓ Parrainage, offre nouveaux clients, avis Google',
  ...
  firstBooking: {
    preview: '{shopName}, ta premiere reservation en ligne !',
    heading: 'Ta premiere resa est arrivee !',
    greeting: 'Bonjour <strong>{shopName}</strong>,',
    intro: 'Une cliente vient de reserver en ligne depuis ta page. Et bonne nouvelle : elle a automatiquement recu sa carte de fidelite.',
    celebrationTitle: 'Premiere reservation en ligne',
    celebrationText: 'Ton agenda se remplit tout seul, et tes clientes sont fidelisees des la premiere visite.',
    ...
    tip3: '→ Dis a tes clientes : « Tu peux aussi reserver en ligne la prochaine fois »',
    cta: 'Voir mes reservations',
    shareTitle: 'Partage ta page',
    shareText: 'Plus ta page est visible, plus tu recois de resas. Partage-la sur tes reseaux sociaux.',
  ...
  programReminder: {
    ...
    bonusText: 'Et si tu actives la reservation en ligne, chaque cliente qui reserve recoit <strong>automatiquement sa carte de fidelite</strong>.',
  ...
  birthdayNotification: {
    ...
    smsConfirmTitle: 'Un SMS a ete envoye a ton/ta client(e) :',
  ...
  planningReminder: {
    ...
    bonusTitle: 'Bonus',
    bonusDesc: 'Chaque cliente qui reserve recoit <strong>automatiquement sa carte de fidelite</strong>. Tu remplis ton agenda et tu fidelises en meme temps.',
    trialNote: 'Il te reste <strong>{daysRemaining} jour{daysPlural}</strong> d\'essai.',
