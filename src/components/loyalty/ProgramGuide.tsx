        ...
        >
          ...
          <div className="p-8">
            ...
            >
              ...
              {/* Mode Article Examples */}
              <div>
                <p className="text-xs font-bold text-orange-600 uppercase tracking-wider mb-3 flex items-center gap-2">
                  <Pizza className="w-3 h-3" /> Mode Article - Exemples
                </p>
                <div className="space-y-2 text-sm">
                  <div className="p-3 rounded-xl bg-white border border-gray-100 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center text-lg">🍕</div>
                    <div className="flex-1">
                      <p className="text-gray-700">Pierre achète 3 pizzas pour la famille</p>
                    </div>
                    <span className="font-bold text-orange-600 whitespace-nowrap">→ +3 points</span>
                  </div>
                  <div className="p-3 rounded-xl bg-white border border-gray-100 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-amber-100 flex items-center justify-center text-lg">☕</div>
                    <div className="flex-1">
                      <p className="text-gray-700">Sophie prend 2 cafés (un pour elle, un pour son collègue)</p>
                    </div>
                    <span className="font-bold text-orange-600 whitespace-nowrap">→ +2 points</span>
                  </div>
                  <div className="p-3 rounded-xl bg-white border border-gray-100 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-yellow-100 flex items-center justify-center text-lg">🥐</div>
                    <div className="flex-1">
                      <p className="text-gray-700">Lucas achète 5 croissants pour le bureau</p>
                    </div>
                    <span className="font-bold text-orange-600 whitespace-nowrap">→ +5 points</span>
                  </div>
                </div>
                <p className="mt-2 text-xs text-gray-500 italic">
                  Après 10 pizzas/cafés/croissants → Récompense : &quot;1 pizza offerte&quot; ou &quot;Le 10ème café gratuit&quot;
                </p>
              </div>
            </motion.div>
