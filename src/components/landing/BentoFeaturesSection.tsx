    ...
    <section className="relative py-20 md:py-28 bg-gray-50/50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-6 md:gap-10 lg:gap-12">
          ...
          <FeatureBlock
            title="Ton programme,"
            titleBold="tes règles."
            description="Tampons ou cagnotte, paliers, récompenses, couleurs — tout se configure en 2 minutes. Une carte à ton image que tes clientes montrent, partagent, et qui les fait revenir."
