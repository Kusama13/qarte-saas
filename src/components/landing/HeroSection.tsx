    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-6 pt-24 lg:pt-32 pb-6 lg:pb-20 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          >
            {/* Glow behind phone */}
            <div className="absolute -inset-8 bg-gradient-to-r from-pink-500/25 via-violet-500/20 to-indigo-500/25 rounded-[4rem] blur-3xl pointer-events-none" />

            {/* Phone Frame */}
            <div className="relative w-[280px] h-[580px] bg-gray-900 rounded-[3rem] p-2 shadow-2xl shadow-gray-900/30">
              {/* Screen */}
