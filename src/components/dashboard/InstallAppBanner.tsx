...
export default function InstallAppBanner() {
  ...
  return (
    <>
      ...
      {showIOSInstructions && (
        <div
          className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-3 bg-black/50 backdrop-blur-sm"
          ...
          >
            <div className="px-4 py-4 text-center bg-gradient-to-r from-indigo-50 to-violet-50">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Accédez au tableau de bord en 1 tap
              </p>
            </div>
              ...
              {isIOS ? (
                <>
                  <div className="flex items-center gap-3 p-2.5 bg-blue-50 rounded-xl border border-blue-200">
                    ...
                    <p className="text-sm text-gray-800">
                      <span className="font-semibold">1.</span> Appuyez sur{' '}
                ...
                <>
                  ...
                  <div className="flex items-center gap-3 p-2.5 bg-gray-50 rounded-xl">
                    ...
                    <p className="text-sm text-gray-800">
                      <span className="font-semibold">2.</span>{' '}
                      <strong>Ajouter un raccourci</strong>
                    </p>
                  </div>
                </>
              )}
