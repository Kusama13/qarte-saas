...
export const DEMO_MERCHANTS: Record<string, DemoMerchant> = {
  'demo-onglerie': {
    ...
    instagram_url: 'https://www.instagram.com/qarte.app', facebook_url: 'https://www.facebook.com/profile.php?id=61587048661028', tiktok_url: 'https://www.tiktok.com/@getqarte', snapchat_url: null,
