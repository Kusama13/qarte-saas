...
- **FR (EUR) Fidélité :** `PLAN_FIDELITY` (19€/mois) + `PLAN_FIDELITY_SEMESTRIAL` (95€/6 mois) + `PLAN_FIDELITY_ANNUAL` (190€/an, legacy) — `STRIPE_PRICE_FIDELITY` + `STRIPE_PRICE_FIDELITY_SEMESTRIAL` + `STRIPE_PRICE_FIDELITY_ANNUAL`
